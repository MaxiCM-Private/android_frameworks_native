...
TEST_F(BufferQueueTest, SetMaxAcquiredBufferCountWithIllegalValues_ReturnsError) {
    ...
    ASSERT_EQ(BAD_VALUE, mConsumer->setMaxAcquiredBufferCount(0));
    ASSERT_EQ(BAD_VALUE, mConsumer->setMaxAcquiredBufferCount(-3));
    ASSERT_EQ(BAD_VALUE, mConsumer->setMaxAcquiredBufferCount(
            BufferQueue::MAX_MAX_ACQUIRED_BUFFERS+1));
    ASSERT_EQ(BAD_VALUE, mConsumer->setMaxAcquiredBufferCount(100));
}
...
TEST_F(BufferQueueTest, SetMaxAcquiredBufferCountWithLegalValues_Succeeds) {
    ...
    ASSERT_EQ(OK, mConsumer->setMaxAcquiredBufferCount(2));
    ASSERT_EQ(OK, mConsumer->setMaxAcquiredBufferCount(
